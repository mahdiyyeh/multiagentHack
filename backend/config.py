...
PMTX_TOKEN = os.getenv("PMTX_TOKEN", "") or os.getenv("PROMETHEUX_API_KEY", "")
PROMETHEUX_API_KEY = PMTX_TOKEN
PROMETHEUX_ORG = os.getenv("PROMETHEUX_ORG", "")
PROMETHEUX_USERNAME = os.getenv("PROMETHEUX_USERNAME", "")
PROMETHEUX_PROJECT_ID = os.getenv("PROMETHEUX_PROJECT_ID", "") or os.getenv("PROMETHEUX_ONTOLOGY_ID", "")
PROMETHEUX_JARVISPY_URL = os.getenv("PROMETHEUX_JARVISPY_URL", "")
PROMETHEUX_API_URL = os.getenv("PROMETHEUX_API_URL", "")
PROMETHEUX_ONTOLOGY_ID = PROMETHEUX_PROJECT_ID
